...
int main(int argc, char *argv[])
{
    ...
    matrix_multiply<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_U, n, q1);
    ...
    matrix_multiply<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_U, n, q2);
    cudaDeviceSynchronize();
    cudaMemcpy(h_A, d_B, size, cudaMemcpyDeviceToHost);
    cudaMemcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
    for (int i = 0; i < 4; i++) 
    ...
    matrix_multiply<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_U, n, q3);
    cudaDeviceSynchronize();
    cudaMemcpy(h_A, d_B, size, cudaMemcpyDeviceToHost);
    cudaMemcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
    for (int i = 0; i < 4; i++) 
    ...
    matrix_multiply<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_U, n, q4);
    cudaDeviceSynchronize();
    cudaMemcpy(h_A, d_B, size, cudaMemcpyDeviceToHost);
    cudaMemcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
    for (int i = 0; i < 4; i++) 
    ...
    matrix_multiply<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_U, n, q5);
    cudaDeviceSynchronize();
    cudaMemcpy(h_A, d_B, size, cudaMemcpyDeviceToHost);
    cudaMemcpy(d_A, h_A, size, cudaMemcpyHostToDevice);
    for (int i = 0; i < 4; i++) 
    ...
    matrix_multiply<<<blocksPerGrid, threadsPerBlock>>>(d_A, d_B, d_U, n, q6);
    cudaDeviceSynchronize();
